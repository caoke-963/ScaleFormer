...
class Data_test(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(test_img.max())
        # ms_image = ms_image.resize((int(ms_image.size[0]*self.upscale_factor),int(ms_image.size[1]*self.upscale_factor)), Image.BICUBIC)
...
class Data_eval(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        pan_image = load_img(self.pan_image_filenames[index])
        _, file = os.path.split(self.ms_image_filenames[index])
        lms_image = ms_image.crop((0, 0, lms_image.size[0] // self.upscale_factor * self.upscale_factor,
